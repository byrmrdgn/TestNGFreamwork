...
public abstract class TestBaseFinal {
    ...
    public void setUpTest() {
        ...
        extentReports.setSystemInfo("Automation Engineer", "Bayram");
        extentHtmlReporter.config().setDocumentTitle("Amozon Arama Testi");// dökuman basligi
        extentHtmlReporter.config().setReportName("Amozon Arama Automation Reports"); // rapor ismi
    }
